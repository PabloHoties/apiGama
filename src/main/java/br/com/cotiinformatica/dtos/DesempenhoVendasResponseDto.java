...
public class DesempenhoVendasResponseDto {
	...
	String desempenho = "Conclusão:<br>"
	        ...
	        + "Revisar e possivelmente reduzir os gastos elevados para melhorar a liquidez.<br><br>"
	        + "Melhoria no Controle Financeiro:<br>"
	        + "Implementar sistemas e processos mais rigorosos para assegurar que as transações sejam registradas corretamente e refletidas com precisão nos saldos.<br><br>"
